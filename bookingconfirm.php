...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for visiting VIT Car Rental! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <!-- BOOKING SUCCESSFUL CONFIRMATION EMAIL -->
        <?php
//$to_email = $customer_email;
$subject = 'VIT Car Rental Booking Successful';
$body = "We have received your booking with order no:". $id . " Booking Details are as follows\n\nClient name- ".$client_name."\nVehicle name- ".$car_name."\nVehicle number- ".$car_nameplate."\nDates- ".$rent_start_date." to ".$rent_end_date."\nTotal fare- Rs.".$fare.
"\n\nPlease take a print out, or save the invoice of your booking for any further queries.\nYou are requested to bring your Id Proof (VIT ID Card) with you for Validation.";
$headers = 'From: denver.hamilton7650@gmail.com';

if (mail($to_email, $subject, $body, $headers)) {
    echo "Booking Email successfully sent to $to_email...";
} else {
